...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_merchants_razorpay_account_id'), 'merchants', ['razorpay_account_id'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.CheckConstraint('autonomous_limit_paise >= 0', name='chk_policy_autonomous_limit_non_negative'),
        sa.CheckConstraint('step_up_threshold_paise >= 0', name='chk_policy_step_up_threshold_non_negative'),
    ...
    op.create_index(op.f('ix_mandates_category_scope'), 'mandates', ['category_scope'], unique=False)
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('mandate_id', 'transaction_id', name='uq_mandate_transaction_reservation')
    )
    op.create_index(op.f('ix_budget_reservations_mandate_id'), 'budget_reservations', ['mandate_id'], unique=False)
    op.create_index(op.f('ix_budget_reservations_transaction_id'), 'budget_reservations', ['transaction_id'], unique=False)
    ...
    op.create_index(op.f('ix_step_up_challenges_transaction_id'), 'step_up_challenges', ['transaction_id'], unique=False)
    op.create_index(op.f('ix_step_up_challenges_status'), 'step_up_challenges', ['status'], unique=False)
    ...
    op.create_index(op.f('ix_replay_records_transaction_id'), 'replay_records', ['transaction_id'], unique=False)
    op.create_index(op.f('ix_replay_records_created_at'), 'replay_records', ['created_at'], unique=False)
    ...
    op.create_index(op.f('ix_nonce_records_transaction_id'), 'nonce_records', ['transaction_id'], unique=False)
    ...
    op.create_index(op.f('ix_action_receipts_transaction_id'), 'action_receipts', ['transaction_id'], unique=False)
    op.create_index(op.f('ix_action_receipts_audit_event_id'), 'action_receipts', ['audit_event_id'], unique=False)
