"""
Razorpay Python SDK — Webhook Signature Verifier
"""
...
class RazorpayWebhookVerifier:
    """Helper utility for verifying HMAC-SHA256 signatures on incoming Razorpay webhooks."""
    ...
    def verify_signature(
        ...
        :param signature: Value of X-Razorpay-Signature or X-Razorpay-Webhook-Signature.
