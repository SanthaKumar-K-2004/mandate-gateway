"""
Razorpay Python SDK — Custom Exceptions
"""
...
class RazorpayError(Exception):
    """Base exception for all Razorpay SDK errors."""
...
class AuthenticationError(RazorpayError):
...
class IdempotencyError(RazorpayError):
...
class ValidationError(RazorpayError):
