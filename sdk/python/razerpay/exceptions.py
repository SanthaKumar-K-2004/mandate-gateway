...
class RazerpayError(Exception):
    ...
    def __init__(self, message: str, code: str = "SDK_ERROR", request_id: str | None = None) -> None:
...
class AuthenticationError(RazerpayError):
    ...
    def __init__(self, message: str = "Invalid API key or credentials.", request_id: str | None = None) -> None:
...
class IdempotencyError(RazerpayError):
    ...
    def __init__(self, message: str = "Idempotency key payload mismatch.", request_id: str | None = None) -> None:
...
class ValidationError(RazerpayError):
    ...
    def __init__(self, message: str = "Invalid request payload.", request_id: str | None = None) -> None:
...
class APIError(RazerpayError):
    ...
    def __init__(self, message: str, status_code: int = 500, code: str = "API_ERROR", request_id: str | None = None) -> None:
